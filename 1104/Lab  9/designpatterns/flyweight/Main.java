package server.structurale.flyweight;

public class Main {
    private static Character[] textCharacters = new Character[100];
    private static CharacterContext[] charactersLocation = new CharacterContext[100];
    ...
    public static void pressKey(String character, int location, CharacterFactory characterFactory) {
        ...
        charactersLocation[nbCharacters] = new CharacterContext(location);
        nbCharacters++;
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i=0; i<nbCharacters; i++) {
            textCharacters[i].print(charactersLocation[i]);
        }
