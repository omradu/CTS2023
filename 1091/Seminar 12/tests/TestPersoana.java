import org.junit.*;
import seminar.junit.classes.IValidariPersoana;
import seminar.junit.classes.Persoana;
...
public class TestPersoana {
    ...
    public static final int VARSTA = IValidariPersoana.VARTSA_MIN; //limitele au fost puse intr-o interfata
    ...
    public void testSetVarsta() throws ExceptiePersoanaVarstaInvalida {
        ...
        /*} catch (ExceptiePersoanaVarstaInvalida e) {
            Assert.fail("Metoda a generat exceptie");
        }*/
