public class Film2 {
    ...
    private Film2(String titlu, int anAparitie, String gen, boolean areLimitaVarsta, double ratingIMDB, int durataInMinute, int bileteVandute, boolean esteDisponibilIn4D, int anProductie) {
        this.titlu = titlu;
    ...
    private void setBileteVandute(int bileteVandute) {
        this.bileteVandute = bileteVandute;
    }
    ...
    public static class FilmBuilder2 {
        ...
        public FilmBuilder2 addBileteVandute(int tbileteVandute) {
            this.bileteVandute = tbileteVandute;
            return this;
        }
        ...
        public Film2 build() {
            //Film2 film = new Film2((titlu, anAparitie, gen, areLimitaVarsta, ratingIMDB, durataInMinute, bileteVandute, esteDisponibilIn4D, anProductie);
            Film2 film = new Film2();
            film.anAparitie = anAparitie;
            film.anProductie = anProductie;
            film.areLimitaVarsta = areLimitaVarsta;
            film.bileteVandute = bileteVandute;
