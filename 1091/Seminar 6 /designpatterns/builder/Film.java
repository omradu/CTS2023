public class Film {
    ...
    public Film(String titlu, int anAparitie, String gen, boolean areLimitaVarsta, double ratingIMDB, int durataInMinute, int bileteVandute, boolean esteDisponibilIn4D, int anProductie) {
        this.titlu = titlu;
    ...
    public static class FilmBuilder {
        ...
        public FilmBuilder addBileteVandute(int tbileteVandute) {
            this.film.bileteVandute = tbileteVandute;
            return this;
        }
